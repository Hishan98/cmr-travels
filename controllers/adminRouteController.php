...
if (isset($_POST['adminCreateRoute']) && $_POST['adminCreateRoute'] == true) {
    ...
    $sql = "INSERT INTO `route`(`routeFrom`, `routeTo`, `departureTime`, `arrivalTime`, `busNumber`) 
    VALUES ('" . $route_from . "','" . $route_to . "','" . $route_departure_time . "','" . $route_arrival_time . "','" . $route_bus_number . "')";
    ...
    $sql = "UPDATE route SET routeFrom='" . $route_from . "', routeTo='" . $route_to . "',departureTime='" . $route_departure_time . "', arrivalTime='" . $route_arrival_time . "',busNumber='" . $route_bus_number . "' WHERE id='" . $route_id . "'";
